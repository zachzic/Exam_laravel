        ...
        <div class="deznav">
            <div class="deznav-scroll">
				<ul class="metismenu" id="menu">
                    <li><a href="http://127.0.0.1:8000/ client">
                    ...
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
							...
							<span class="nav-text">Fonctionnalitées</span>
						</a>
                        <ul aria-expanded="false">
                            <!-- <li><a href="/ client/Partenaire"> Partenaire</a></li>
                            <li><a href="/ client/Programme"> Programme</a></li>
                            <li><a href="/ client/Service"> Service</a></li> -->

                            
                            <!--<li><a href="./?app=Email">Email</a></li>
                            <li><a href="./?app=Calendrier">Calendrier</a></li>
