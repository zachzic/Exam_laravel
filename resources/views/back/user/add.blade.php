...
<div class="content-wrapper"> 
    ...
    <div class="content-header sty-one">
      <h1 class="text-black">Ajouts de users</h1>
      <ol class="breadcrumb">
        <li><a href="#">Home</a></li>
      ...
      <div class="row">
        <div class="col-lg-12">
          <div class="card card-outline">
            ...
            <h5 class="text-white m-b-0">ENREGISTREMENT   <a href="{{route('user.index')}}" class="btn btn-success">Lister</a></h5>
            </div>
            <div class="card-body">
            <div class="row">
            ...
            <form action="{{route('user.store')}}" method="POST" enctype="multipart/form-data">
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="exampleInputuname" placeholder="nom" name="name">
              </div>
              
              <div class="form-group">
                <label for="exampleInputEmail1">email</label>
                <input type="mail" class="form-control" id="exampleInputEmail1" placeholder="email" name="email">
              </div>
              <div class="form-group">
