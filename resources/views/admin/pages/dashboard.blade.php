...
<?php
	...
	$countProgrammes = Programme::count();
	$countPartenaires = Partenaire::count();
									...
									<div class="card-body">
										<div class="media align-items-center">
											...
											<div class="media-body">
												...
												<span class="title text-black font-w600">{{ $countProgrammes }} programmes</span>
											</div>
										</div>
									</div>
									...
									<div class="card-body">
										<div class="media align-items-center">
											...
											<div class="media-body">
												...
												<span class="title text-black font-w600">{{ $countPartenaires }} partenaires</span>
											</div>
										</div>
									...
									<div class="card-body">
										<div class="media align-items-center">
											...
											<div class="media-body">
												...
												<span class="title text-black font-w600">{{ $countServices }} Services</span>
											</div>
										</div>
									</div>
									<div class="effect bg-danger"></div>
